...
export default function () {
  const wms = http.get(`${base}/wms?service=WMS&version=1.3.0&request=GetMap&layers=demo:demo_places&styles=&crs=EPSG:4326&bbox=34,31,36,33&width=512&height=512&format=image/png`);
  const wfs = http.get(`${base}/wfs?service=WFS&version=2.0.0&request=GetFeature&typeNames=demo:demo_places&outputFormat=application%2Fjson`);
