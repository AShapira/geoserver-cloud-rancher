...
$script:Versions = @{
    ...
    Rancher = '2.14.3'
    K3s = 'v1.36.2+k3s1'
    K3sDockerTag = 'v1.36.2-k3s1'
    GeoServerChart = '3.0.0'
    GeoServerImage = '3.0.0'
    ...
    JcrProxyImage = 'nginxinc/nginx-unprivileged:1.31.2-alpine'
    JcrDatabaseImage = 'postgres:16-alpine'
    PostgisImage = 'postgis/postgis:18-3.6'
    PgadminImage = 'dpage/pgadmin4:9.16'
    RabbitImage = 'rabbitmq:4.3.2-management-alpine'
    CurlImage = 'curlimages/curl:8.21.0'
    K6Image = 'grafana/k6:2.1.0'
    CanaryImage = 'busybox:1.38.0'
    QgisBaseImage = 'kasmweb/core-ubuntu-noble:1.19.0'
    PgStacImage = 'ghcr.io/stac-utils/pgstac:v0.9.11'
    StacApiImage = 'ghcr.io/stac-utils/stac-fastapi-pgstac:6.3.1'
    StacBrowserVersion = '4.0.1'
    GdalImage = 'ghcr.io/osgeo/gdal:ubuntu-small-3.13.1'
